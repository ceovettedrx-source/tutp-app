...
JSON string rule: whenever a string value needs to quote speech or a phrase inline (e.g. something a teacher says aloud), use curly/smart quotes (“ ”) — never straight double-quotes (") inside a string value, since they break the JSON. Straight double-quotes are only for the JSON syntax itself.
